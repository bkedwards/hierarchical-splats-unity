...
namespace GaussianSplatting.Editor
{
    ...
    public class GaussianSplatAssetCreator : EditorWindow
    {
        ...
        unsafe void CreateAsset()
        {
            ...
            ReorderMorton(inputSplats, boundsMin, boundsMax); //Unsure if this is necessary for hierarchical
            ...
            // COME BACK HERE AFTER INPUT SPLATS //
            ...
            // Print memory usage
            Debug.Log($"Total Memory Used (3): {totalMemoryInGB:F2} GB");
        }
